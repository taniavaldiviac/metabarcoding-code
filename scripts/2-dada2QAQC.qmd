...
Este script implementa un **pipeline completo y reproducible** para el análisis de datos de metabarcoding de ADN ambiental (eDNA) utilizando el paquete **dada2** en R. El objetivo es transformar lecturas crudas de secuenciación de alto rendimiento en una **tabla de variantes de secuencias amplificadas (ASVs)** con asignación taxonómica.
...
✅ **Flexible**: procesa múltiples marcadores usando tabla de configuración  (
✅ **Robusto**: maneja archivos vacíos, valida inputs, protege contra errores  
...
**¡El pipeline está diseñado para aprender haciendo!** Cada sección está comentada para que entiendas qué hace y por qué.
